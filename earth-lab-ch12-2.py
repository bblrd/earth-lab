...
# In the scenario below you crop / mask the data to the actual geometry shape of the fire boundary. Because the MODIS pixels are
# larger and the study area is relative small, you can’t visually see a difference however you will see a difference with landsat and
# other higher resolution data.
